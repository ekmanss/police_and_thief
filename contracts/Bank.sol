...
contract Bank is Ownable, IERC721Receiver, Pauseable {
   ...
   */
    function _addThiefToBank(address account, uint256 tokenId) public whenNotPaused _updateEarnings {
        bank[tokenId] = Stake({
        owner : account,
   ...
   */
    function _addPoliceToPack(address account, uint256 tokenId) public {
   ...
   */
    function _claimThiefFromBank(uint256 tokenId, bool unstake) public returns (uint256 owed) {
   ...
   * @return owed - the amount of $LOOT earned
   */
    function _claimPoliceFromPack(uint256 tokenId, bool unstake) public returns (uint256 owed) {
   ...
   */
    function _payPoliceTax(uint256 amount) public {
   ...
   */
    function _alphaForPolice(uint256 tokenId) public view returns (uint8) {
