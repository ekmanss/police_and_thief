...
contract Traits is Ownable, ITraits {
   ...
   */
    ...
    function draw(string memory png) public pure returns (string memory) {
        return string(abi.encodePacked(
                '<image x="4" y="4" width="32" height="32" image-rendering="pixelated" preserveAspectRatio="xMidYMid" xlink:href="data:image/png;base64,',
                png,
                '"/>'
   ...
   */
    function attributeForTypeAndValue(string memory traitType, string memory value) public pure returns (string memory) {
        return string(abi.encodePacked(
                '{"trait_type":"',
                traitType,
                '","value":"',
